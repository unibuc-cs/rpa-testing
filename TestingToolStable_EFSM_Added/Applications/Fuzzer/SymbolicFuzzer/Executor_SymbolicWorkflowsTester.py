...
from EFSM_Testing import EFSM_Tester
...
class SymbolicWorflowsTester:
    def __init__(self,
        ...
        elif strategyToUse == SymbolicSolversStrategiesTypes.STRATEGY_EFSM:
            self.symbolicSolverStrategy = EFSM_Tester(self.workflowGraph)
        else:
